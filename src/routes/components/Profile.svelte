<div class="rside">
  <div class="profile">
    <img src="/profileImage.png" alt="profile" class="profile_image" />
    <div class="name">박오인</div>
    <div class="divider"></div>
    <div class="desc">개발자가 되고 싶은 영원한 잼민이</div>
    <div class="socials">
      <a href="https://x.com/oein0219">
        <svg height="1.5rem" viewBox="0 0 512 512" width="1.5rem"
          ><symbol id="ai:fa6-brands:x-twitter"
            ><path
              d="M389.2 48h70.6L305.6 224.2L487 464H345L233.7 318.6L106.5 464H35.8l164.9-188.5L26.8 48h145.6l100.5 132.9zm-24.8 373.8h39.1L151.1 88h-42z"
              fill="currentColor"
            ></path></symbol
          ><use xlink:href="#ai:fa6-brands:x-twitter"></use></svg
        >
      </a>
      <a href="https://github.com/Oein">
        <svg height="1.5rem" viewBox="0 0 496 512" width="1.5rem"
  ...
  <div class="projects">
    <a href="https://github.com/poikr/chzzkExt">
      <svg
        stroke="currentColor"
        fill="currentColor"
        stroke-width="0"
  ...
  <div class="projects">
    <a href="https://buymeacoffee.com/oein0219">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
